...
END_BLOCK = 5049100
BATCH_SIZE = 1000
BAD_OPCODES = ['CODESIZE', 'CODECOPY', 'EXTCODESIZE', 'EXTCODECOPY', 'CREATE', 'CALLCODE', 'DELEGATECALL', 'SELFDESTRUCT', 'STATICCALL', 'RETURNDATACOPY', 'RETURNDATASIZE'] # from Instrumentation.hs
