from examples.SimpleMontyHall.test.utils import *
...
class TestMonthyHallFlo(PyEthereumTestCase):
    ...
    def test_open_door_fails(self):
        ...
        self.assert_stage_failed({}, ErrorMsgs.OPEN_DOOR_FAILED, msg)
        ...
        for sender in [self.player, self.creator]:
            ...
            self.assert_stage_failed({"senders": senders},
                                     ErrorMsgs.OPEN_DOOR_FAILED, msg)
    ...
    def test_round2_fails(self):
        ...
        for g_id in [1, -1]:
            ...
            self.assert_stage_failed({"game_ids": game_ids},
                                     ErrorMsgs.PLAY_MONTY_ROUND_2_FAILED, msg)
        ...
        self.assert_stage_failed({}, ErrorMsgs.PLAY_MONTY_ROUND_2_FAILED,
    ...
    def test_payout(self):
        ...
        self.assert_special_failed(0, ErrorMsgs.PAYOUT_FAILED, msg,
        ...
        for g_id in [1, -1]:
            ...
            self.assert_special_failed(g_id, ErrorMsgs.PAYOUT_FAILED, msg,
                                       sender=self.player, bool=False)
    ...
    def test_refund_inactive_fails(self):
        ...
        self.assert_special_failed(game_id, ErrorMsgs.REFUND_INACTIVE_FAILED,
                                   msg, sender=self.house)
    ...
    def test_refund_after_escape_fails(self):
        ...
        self.assert_special_failed(game_id, ErrorMsgs.REFUND_AFTER_HATCH_FAILED,
                                   msg, sender=self.house)
        ...
        for gid in [-1, game_id + 1]:
            ...
            self.assert_special_failed(gid, ErrorMsgs.REFUND_AFTER_HATCH_FAILED,
                                       msg, sender=self.house)
